...
class Calculator:
    ...
    def __init__(self, master:'Tk'):
        ...
        self.add_button.grid(row=2, column=0, sticky='WESN')
        self.subtract_button.grid(row=2, column=1, sticky='WESN')
        self.multiplication_button.grid(row=2, column=2, sticky='WESN')
        self.division_button.grid(row=2, column=3, sticky='WESN')
